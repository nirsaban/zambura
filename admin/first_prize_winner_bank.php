...
if ($_GET['del'])
{
	$sql = "DELETE FROM `first_prize_winner_bank` WHERE `id` = '".$_GET['del']."'";
	$del = mysqli_query($sql);	
}

$i = 0;
//LIMIT 50
$query = "SELECT * FROM `first_prize_winner_bank`  ORDER BY `id` DESC ";
$result=mysqli_query($query) or die('error connecting55'); 
$num_rows = mysqli_num_rows($result);


$updateQuery1 = "UPDATE `first_prize_winner_bank` SET  `is_seen` ='1' WHERE `is_seen` ='0'";
$update1 =  mysqli_query($updateQuery1) or die(mysqli_error());
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="first_prize_winner_bank.php" class="pull-right" style="width:100%; text-align:right">פרטי בנק <span class="pull-left badge bg-lightred"><? print $num_rows;?></span></a></li>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>פרטי בנק (<?= $num_rows;?>)</strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">הקשר לבעל החשבון</th>
												<th align="right" width="text-align:right; 30%">מספר חשבון</th>
												<th align="right" width="text-align:right; 30%">בעל החשבון</th>								
												<th align="right" width="text-align:right; 30%">מספר סניף</th>			
												<th align="right" width="text-align:right; 30%">בנק</th>
                                                <th align="right" width="text-align:right; 30%">טלפון</th>
                                                <th align="right" width="text-align:right; 30%">שם הזוכה</th>
												<th width="5%">#</th>
										...
										<?
                                            ...
                                            $query1 = "SELECT * FROM `users`  WHERE `index` = '".$row['userId']."' ";
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions" >
													...
													<!--
													<button   onClick="editQuestion('<?= $row['id'];?>')"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10" ><i class="fa fa-pencil"></i> Add <i class="after fa fa-plus"></i></button>
													-->
													
												   
											</td>										
                                            <td align="center" style="text-align:center; direction:rtl;"><? print date("d/m/y H:i:s", strtotime($row["created_at"]));?></td>
                                            

											
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['backAccountRelation']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['bankAccountNumber'] );?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['bankAccountName']);?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['bankBranchNumber']);?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['bankName']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['userPhoneNumber']);?></td>
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row1['firstname']);?> <?= stripslashes($row1['lastname']);?></td>
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['id']);?></td>
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "first_prize_winner_bank.php?del="+index;
				}
			}
