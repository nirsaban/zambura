...
if ($_GET['del'])
{
	//$sql = "DELETE FROM `daily_winners` WHERE `id` = '".$_GET['del']."'";
...
$query = "SELECT * FROM `daily_winners`  WHERE `created_at` LIKE '".$newdate."%' AND `winner_type` = '".$_POST['winner_type']."' ORDER BY `id` DESC ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="daily_winners.php" class="pull-right" style="width:100%; text-align:right">זוכים יומיים </a></li>
									...
									<div class="row" align="center"   >
                                        ...
                                        <div class="form-group col-md-12" align="center">
                                            <div class='input-group newdatepicker w-360 mt-10' >
                                                ...
                                                <select name="winner_type" class="form-control"  required>
                                                    <option value="0" <?php if ($_POST['winner_type'] == "0") { print 'selected'; } ?>>100 שקל</option>
                                                    <option value="1" <?php if ($_POST['winner_type'] == "1") { print 'selected'; } ?>>כרטיס זוגי לסרט</option>
                                                </select>
                                            </div>
                                        </div>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>זוכים יומיים  (<?= $num_rows;?>)</strong></h1>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            <thead>
                                            <tr>
												<th align="right" width="text-align:right; width:30%">הרשמה</th>
												<th align="right" width="text-align:right; width: 30%">מנותק</th>
                                                <th align="right" width="text-align:right; width:30%">יום הולדת</th>
                                                <th align="right" width="text-align:right; width:30%">מין</th>
												<th align="right" width="text-align:right; width:30%">עיר</th>
												<th align="right" width="text-align:right; width:30%">מייל</th>
												<th align="right" width="text-align:right; width:30%">שם</th>
												<th width="5%"></th>
												<th width="5%">#</th>
										...
										<?
											while ( $row = mysqli_fetch_array($result) )
											{
                                                ...
                                                $query5 = "SELECT * FROM `users`  WHERE `index` = '".$row['user_id']."' ";
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="text-align:center; direction:rtl;"><? print date("d/m/y H:i:s", strtotime($row5["date"]));?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($loggedInStatus);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row5['birthday']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($gender);?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row5['address']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row5['email'] );?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row5['firstname']);?> <?= stripslashes($row5['lastname']);?></td>
                                            
											<td align="center" style="text-align:center; direction:rtl;">
											<?
											if ($row5['image'])
												print '<img src="../php/'.$row5['image'].'" style="width:40px; height:40px;">';
											else
												print '';
											?>
											</td>

											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row5['index']);?></td>
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "daily_winners.php?del="+index;
				}
			}
