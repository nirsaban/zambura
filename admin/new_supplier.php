...
if ($_FILES['file2']['name'])
{
	...
	else
	{
		...
		`contact_name`,`phone`,`image`)  VALUES (
		'".addslashes($_POST['suppname'])."',
		'".addslashes($_POST['contactmail'])."',
		'".addslashes($_POST['contactname'])."',
		...
		header('Location: manage_brances.php?id='.$insertId.'');		
						...
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>הוספת ספק</strong> </h1>
                                </div>
                                <!-- /tile header -->
                                    ...
                                    <form name="form2" action="" method="post" role="form" id="form2" enctype="multipart/form-data" data-parsley-validate>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="suppname"  id="suppname" class="form-control" tab-index="1" required >
                                            </div>											
                                        </div>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="contactmail"  id="contactmail" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="contactname"  id="contactname" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                ...
                                                <input type="tel" name="phone"  id="phone" data-parsley-type="number" data-parsley-error-message="יש להזין מספר בלבד" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
                                ...
                                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top" style="background:#fff !important;">
                                    <!-- SUBMIT BUTTON -->
                                    <button id="form2Submit" class="btn btn-lightred" type="submit">שמירה ומעבר לניהול סניפים</button>
                                </div>
                                <!-- /tile footer -->
