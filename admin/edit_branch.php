...
*/
	...
	$updateQuery = "UPDATE `supplier_brances` 
	 SET   
	 `name` ='".addslashes($_POST['address'])."',	 
	 `address` ='".addslashes($_POST['address'])."',
	 `location_lat` ='".addslashes($_POST['lat'])."',
	 `location_lng` ='".addslashes($_POST['lan'])."'
...
header('Location: manage_brances.php?id='.$_GET['supplier'].'');				
...
$query = "SELECT * FROM `supplier_brances` WHERE `index` = '".$_GET['id']."'";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders">
                                    <li class="active" style="text-align:right;"><a href="manage_brances.php?id=<?= $_GET['supplier'];?>">חזרה לסניפים </a></li>
                                </ul>
								<!--
						...
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>עריכת סניף</strong> </h1>
                                </div>
                                <!-- /tile header -->
                                    ...
                                    <form name="form2" action="" method="post" role="form" id="form2" enctype="multipart/form-data" data-parsley-validate>
										...
										<div class="row">
											...
											<div class="form-group col-md-12">
                                                <label for="suppliername">כתובת מלאה: </label>
												<input id="searchTextField" type="text" tab-index="3"  value="<? print stripslashes($row['name']);?>" name="address"   class="form-control" required>
                                            </div>											
