...
if ($_GET['del'])
{
	mysqli_query("DELETE FROM `gallery` WHERE `index` = '".$_GET['del']."'");
}
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders">
                                    <li class="active" style="text-align:right;"><a href="banners.php"> חזרה לבאנרים <span class="pull-right badge bg-lightred"><? print $num_rows;?></span></a></li>
                                </ul>
								<!--
						...
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>באנרים <?= $TypeArray[$_GET['type']];?> (<?= stripslashes($_GET['name']);?>)</strong> </h1>
                                </div>
                                <!-- /tile header -->
...
$query2 = "SELECT * FROM `gallery` WHERE `type` = '".$_GET['type']."' AND `gallery_id` = '".$_GET['id']."'";
...
?>
	<tr class="template-download fade in">
          ...
          <td class="text-right actions">
              ...
              <button class="btn btn-danger btn-sm delete" data-type="DELETE" onClick="ConfirmDelete(<? print $row2['index'];?>)">
                <i class="fa fa-trash-o"></i>
                <span> מחיקה</span>
              </button>
          </td>
       ...
       <!-- ============================================
        ...
        <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "banner_manage.php?type=<? print $_GET['type'];?>&del="+index+"&id=<? print $_GET['id'];?>&name=<? print $_GET['name'];?>";
				}
			}				
        </script>
        <!--/ Page Specific Scripts -->
