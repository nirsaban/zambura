                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
										...
										<?
											...
											// WHERE `deleted` = '0'
                                            if ($_GET['cat'])
											    $query = "SELECT * FROM `questions` WHERE `category_id` = '".$_GET['cat']."'  ORDER BY `index` DESC ";
                                            else
                                                $query = "SELECT * FROM `questions`   ORDER BY `index` DESC ";
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index,type)
			{
				...
				if (confirmbox)
				{
					window.location = "questions.php?cat=<?= $_GET['cat'];?>&status="+deletestatus+"&del="+index;
				}
			}
