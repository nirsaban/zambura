...
if ($_POST['catindex'] == "0")
{
	$sql= "INSERT INTO `tips` (`title`)  VALUES ('".addslashes($_POST['cattitle'])."')";
...
if ($_POST['deal_date'])
{
	//$query1 = "SELECT * FROM `tips_dates`  WHERE `type` = '".$_POST['sugselect']."' AND `tip_id` = '".$_POST['tipid']."' AND `date` = '".$_POST['deal_date']."' ORDER BY `index` DESC";
	$query1 = "SELECT * FROM `tips_dates`  WHERE `date` = '".$_POST['deal_date']."'  AND `type` = '".$_POST['sugselect']."'  ORDER BY `index` DESC";

	$result1 =mysqli_query($query1) or die('error connecting55'); 
	$num1 = mysqli_num_rows($result1);
	if ($num1 == 0)
	{
		$sql= "INSERT INTO `tips_dates` (`tip_id`,`date`,`type`)  VALUES ('".addslashes($_POST['tipid'])."','".addslashes($_POST['deal_date'])."','".addslashes($_POST['sugselect'])."')";
		$InsertSql = mysqli_query($sql);				
	}
...
<!--                                <a href="#"  onClick="addCatagory(0,'','הוספת טיפ')" data-toggle="modal" data-target="#tipmodal" data-options="splash-2 splash-ef-9" class="btn btn-sm btn-lightred b-0 br-2 text-strong">הוספת טיפ</a>-->
<!---->
<!--                            </div>-->
<!---->
<!---->
...
<!--									<li style="text-align:right; background-color:#E0E0E0;"><a href="tips.php" style="text-align:right"><i class="fa fa-fw fa-circle text-red pull-right" style="padding-top:3px;"></i>טיפים</a></li>-->
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font"><strong>טיפים </strong></h1>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage2">
                                            <thead>
                                            <tr>
										...
										<?
											$i = 0;
											//WHERE `deleted` = '0'
											$query = "SELECT * FROM `tips`   ORDER BY `index` DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
													...
													<button onClick="addTipDate('<?= $row['index'];?>','הוספת תאריך')"  data-toggle="modal" data-target="#adddate" data-options="splash-2 splash-ef-9" class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-calendar-o"></i> Add <i class="after fa fa-plus"></i></button>
													<button  onClick="editCatagory('<?= $row['index'];?>','עריכת טיפ')" data-toggle="modal" data-target="#tipmodal" data-options="splash-2 splash-ef-9"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-pencil"></i> Add <i class="after fa fa-plus"></i></button>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
									...
									<div class="form-group" style="direction:rtl;">
										<label for="exampleInputEmail1">הזן טיפ:</label>
										<input type="text" class="form-control" value='' name="cattitle" id="cattitle" placeholder="הזן טיפ">
									</div>   
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index,type)
			{
				...
				if (confirmbox)
				{
					window.location = "tips.php?status="+deletestatus+"&del="+index;
				}
			}
