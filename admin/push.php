...
$g = 0;
  ...
  function sendMessage($desc,$deviceid,$image)
  {


      define( 'API_ACCESS_KEY', 'AAAAbbxXF0s:APA91bHlZI_YP97mTxOyfUI4DkktzRmblIAR3mDnoWPlEuedt8TkNA8nC44Qw4_afMTZQhX9pceTzPz1YCX9BUYer4wuqQj6vFSm770IRX32c41BlIQhhuTE-Xlj8tmy10grFcxGA1UM' );
	...
	if (is_array($_POST['pushid']))
	{
		...
		if ($_POST['details'])
		{
			foreach ($pushids as $sendid)
			{
			    ...
			    //exit;
				$g++;
				sendMessage($_POST['details'],$sendid,$newfile);
			}
