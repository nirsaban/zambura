...
$query = "SELECT * FROM `push_logs`  WHERE `created_at` LIKE '".$newdate."%' ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="push_logs.php" class="pull-right" style="width:100%; text-align:right"> לוגים פוש</a></li>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>לוגים פוש  (<?= $num_rows;?>)</strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
                                                ...
                                                <th  width="text-align:center; width:20%">push id</th>
                                                <th  width="text-align:center; width:20%">שגיאה</th>
                                                <th  width="text-align:center; width:20%">טקסט</th>
                                                <th  width="text-align:center; width:20%">קיבל פוש</th>
                                        ...
                                        <tr>
                                            <td align="center" style="text-align:center; direction:rtl;">
                                                <? print date("d/m/y H:i:s", strtotime($row["created_at"]));?>
                                             </td>

                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row10['push_id']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['log']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['text']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;">
                                                    <?= $recived;?></a>
                                            </td>
								            <td align="center" style="text-align:center; direction:rtl;">
