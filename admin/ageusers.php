...
if ($_POST['searchdate']) {
    $query = "SELECT *, FLOOR(DATEDIFF (NOW(), birthday)/365) AS mAge FROM users WHERE FLOOR(DATEDIFF (NOW(), birthday)/365) BETWEEN ".$_POST['startage']." AND ".$_POST['endage']."  AND `date` >= '2018-08-01' ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="ageusers.php" class="pull-right" style="width:100%; text-align:right"> הרשמות לפי גיל</a></li>
                            ...
                            <div class="p-15 bg-white b-b">
                                    ...
                                    <div class="form-group col-md-12" align="center">
                                        <div class='input-group' >
                                            <label style="direction: rtl;">מגיל: </label>
                                            <input type="number" name="startage"   class="form-control"  required>
                                        </div>
                                        </div>

                                        <div class="form-group col-md-12" align="center">
                                            <div class='input-group' >
                                                <label style="direction: rtl;">עד גיל: </label>
                                                <input type="number" name="endage"   class="form-control"  required>
                                            </div>
                                        </div>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>הרשמות לפי גיל  (<?= $num_rows;?>)</strong></h1>
									<div style="direction: rtl;">
                                        <div><strong>מגיל: <?= $_POST['startage'];?></strong></div>
                                        <div><strong> עד גיל: <?= $_POST['endage'];?></strong></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">קיבל בונוס שני</th>
												<th align="right" width="text-align:right; 30%">קיבל בונוס ראשון</th>

												<!--
												<th align="right" width="text-align:right; 30%">הוזמנו</th>
										...
										<?
											...
											$result20=mysql_query($query20) or die('error connecting55');
											$num_rows20 = mysql_num_rows($result20);
                                        ...
                                        <tr>
											...
											<!--
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['points']);?></td>
											-->
											
											<td align="center" style="text-align:center; direction:rtl;"><?= $prize2;?></td>
											<td align="center" style="text-align:center; direction:rtl;"><?= $prize1;?></td>
											...
											if ($row['image'])
											{
												print '<img src="'.$row['image'].'" style="width:40px; height:40px;">';
											}
											else 
											{
												print '';
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "ageusers.php?del="+index;
				}
			}
