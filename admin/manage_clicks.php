...
$query50 = "SELECT * FROM `suppliers`  WHERE `index` = '".$_GET['id']."' ";
                            ...
                            <div class="p-15 bg-white b-b">
								...
								<div align="center">
									<div class="form-group col-md-6">
										<label for="suppliername" style="direction:rtl;">תאריך סיום: </label>
										<input  type="text" tab-index="3" id="dateselect"  name="enddate" value="<?= $_POST['enddate'];?>"  class="form-control dateselect" required>
									</div>	
									
									<div class="form-group col-md-6">
										<label for="suppliername" style="direction:rtl;">תאריך התחלה: </label>
										<input  type="text" tab-index="3"  id="dateselect"  name="startdate" value="<?= $_POST['startdate'];?>"   class="form-control dateselect" required>
									</div>	
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>קליקים - <?= stripslashes($row50['name']);?></strong></h1>
								
								<div style="display:inline;">
									<a href="clickexport.php?id=<?= $_GET['id'];?>&startdate=<?= $_POST['startdate'];?>&enddate=<?= $_POST['enddate'];?>">
										<img src="assets/images/csv.png" style="width:50px; height:50px;">
									</a>
								</div>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
											...
											-->
											<th align="right" style="text-align:right !important; width: 40%;">תאריך</th>
												<th align="right" style="text-align:center !important; width: 30%;">קליקים</th>	
												<th align="right" style="text-align:center !important; width: 30%;">שם הדיל</th>	
										...
										<?
											...
											// AND `date` >= '".$newstart."' AND `date` <= '".$enddate."'
											if ($_POST['searchdate'])
											{
											...
											$totalCount = $totalCount+$row['counter'];
										?>
                                        <tr>
										
 										
                                            <td align="right" style="text-align:right  !important; direction:rtl;"><?= date('d/m/Y',strtotime($row['date']));?></td>
                                            <td align="center" style="text-align:center  !important; direction:rtl;"><?= stripslashes($row['counter']);?></td>
                                            <td align="center" style="text-align:center  !important; direction:rtl;"><?= stripslashes($row20['title']);?></td>
                                        </tr>
										<?
										}
										?>
										...
										<tr>
										<td colspan="3">
										<p style="direction:rtl;"> סה"כ : <?= $totalCount;?></p>
										</td>
