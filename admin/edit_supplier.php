...
$query2 = "SELECT * FROM `suppliers` WHERE `index` = '".$_GET['id']."'";
...
{
	$newfile2 = stripslashes($row2['ArticleImage2']);
	...
	$updateQuery = "UPDATE `suppliers` 
	 SET   
	 `name` ='".addslashes($_POST['suppname'])."',
	 `email` ='".addslashes($_POST['contactmail'])."',
	 `contact_name` ='".addslashes($_POST['contactname'])."',
...
$query = "SELECT * FROM `suppliers` WHERE `index` = '".$_GET['id']."'";
                ...
                <div class="page page-full page-mail">
                    ...
                    <div class="tbox tbox-sm">
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders">
                                    <li class="active" style="text-align:right;"><a href="suppliers.php">חזרה לספקים </a></li>
						...
						<div class="alert alert-success">
							<strong>כתבה עודכנה בהצלחה</strong>
						</div>
						<?
						}
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>עריכת ספק</strong> </h1>
                                </div>
                                <!-- /tile header -->
                                    ...
                                    <form name="form2" action="" method="post" role="form" id="form2" enctype="multipart/form-data" data-parsley-validate>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="suppname" value="<?= stripslashes($row['name']);?>" id="suppname" class="form-control" tab-index="1" required >
                                            </div>											
                                        </div>
										...
										<div class="row">
											<div class="form-group col-md-12">
                                                <label for="suppliername">חשבון אימייל: </label>
                                                <input type="text" name="contactmail" value="<?= stripslashes($row['email']);?>"  id="contactmail" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
					
										<div class="row">
											<div class="form-group col-md-12">
                                                <label for="suppliername">שם איש קשר: </label>
                                                <input type="text" name="contactname" value="<?= stripslashes($row['contact_name']);?>"  id="contactname" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
					
										<div class="row">
											<div class="form-group col-md-12">
                                                <label for="suppliername">מספר פלאפון: </label>
                                                <input type="tel" name="phone" value="<?= stripslashes($row['phone']);?>"  id="phone" data-parsley-type="number" data-parsley-error-message="יש להזין מספר בלבד" class="form-control" tab-index="1"  >
                                            </div>											
                                        </div>
