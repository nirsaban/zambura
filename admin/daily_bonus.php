...
$query = "SELECT * FROM `users_points`  WHERE `date` LIKE '".$newdate."%' AND `is_bonus` = '1'";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="daily_bonus.php" class="pull-right" style="width:100%; text-align:right">ענו על שאלת בונוס </a></li>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>ענו על שאלת בונוס  (<?= $num;?>)</strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
                                                ...
                                                <th  width="text-align:center; width:20%">נכון/לא נכון</th>
                                                <th  width="text-align:center; width:20%">שאלה</th>
										...
										<?
                                        	...
                                        	while ( $row = mysqli_fetch_array($result) )
											{
                                                ...
                                                $query1 = "SELECT * FROM `users`  WHERE `index` LIKE '".$row['user_id']."' ";
                                                $result1=mysqli_query($query1) or die('error connecting55');
                                                $row1 = mysqli_fetch_array($result1);


                                                $query2 = "SELECT * FROM `questions`  WHERE `index` LIKE '".$row['question_id']."' ";
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="text-align:center; direction:rtl;"><?= date("d/m/y H:i:s", strtotime($row["date"]));?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= $isCorrect;?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= $row2['question'];?></td>

								            <td align="center" style="text-align:center; direction:rtl;">
                                                <?= stripslashes($row1['firstname']);?> <?= stripslashes($row1['lastname']);?>
                                            </td>
											...
											if ($row1['image'])
											{
												print '<img src="../php/'.$row1['image'].'" style="width:40px; height:40px;">';
											}
											else
											{
												print '';
