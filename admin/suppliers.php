...
if ($_POST['deal_date'])
{
	$query1 = "SELECT * FROM `questions_dates`  WHERE `question_id` = '".$_POST['questionid']."' AND `date` = '".$_POST['deal_date']."' ORDER BY `index` DESC";
...
<!--									<li style="text-align:right; background-color:#E0E0E0;"><a href="suppliers.php" style="text-align:right"><i class="fa fa-fw fa-circle text-red pull-right" style="padding-top:3px;"></i>ספקים</a></li>																		-->
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font"><strong>ספקים </strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">קליקים</th>	
												<th align="right" width="text-align:right; 30%">דילים</th>								
												<th align="right" width="text-align:right; 30%">אימייל</th>
												
												
												<th align="right" width="text-align:right; 30%">איש קשר</th>
										...
										<?
											$i = 0;
											$query = "SELECT * FROM `suppliers`  WHERE `deleted` = '0' ORDER BY `index` DESC";
											...
											$query2 = "SELECT * FROM `deals`  WHERE `supplier_id` = '".$row['index']."' ";
											$result2=mysqli_query($query2) or die('error connecting55'); 
											$num2 = mysqli_num_rows($result2);

											$query3 = "SELECT * FROM `deal_clicks`  WHERE `supplier_id` = '".$row['index']."' ";
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
												...
												<button  onClick="manageClicks('<?= $row['index'];?>')"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-bar-chart"></i> Add <i class="after fa fa-plus"></i></button>

												<button  onClick="editBrances('<?= $row['index'];?>')"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-map-marker"></i> Add <i class="after fa fa-plus"></i></button>
                                            ...
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($num3);?></td>

                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($num2);?></td>
											
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['email']);?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['contact_name']);?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['phone']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['name']);?></td>
...
<!--                    </div>-->
        ...
        ================================================ -->
         <script>
			...
			{
				window.location = "edit_supplier.php?id="+index;

			}
			function editBrances(index)
			{
				window.location = "manage_brances.php?id="+index;
			}
			
			function manageClicks(index)
			{
				window.location = "manage_clicks.php?id="+index;
			}
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "suppliers.php?del="+index;
				}
			}
