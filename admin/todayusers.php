...
$query = "SELECT * FROM `users`  WHERE `date` LIKE '".$newdate."%' AND `deleted` = '0' ORDER BY `index` DESC ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="todayusers.php" class="pull-right" style="width:100%; text-align:right">משתמשים לפי תאריך <span class="pull-left badge bg-lightred"><? print $num_rows;?></span></a></li>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>משתמשים לפי תאריך  (<?= $num_rows;?>)</strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">נקודות יומיות</th>
										...
										<?
											...
											if ($row['prize2'] == 1)
                                                ...
                                                $query2 = "SELECT * FROM `daily_points`  WHERE `user_id` = '".$row['index']."' AND `point_date` = '".$newdate."' ";
                                                $result2=mysqli_query($query2) or die('error connecting55');
                                               while ( $row2 = mysqli_fetch_array($result2) )
											{

                                                $correctAnswers += $row2['correctAnswerCount'];
                                                $wrongAnswers += $row2['wrongAnswerCount'];
                                                $totalPoints += $row2['points'];
                                                $questions++;
											}
                                                $total_games =  mysqli_num_rows($result2);
...
<!--											<td align="center" style="text-align:center; direction:rtl;">--><?//= $prize1;?><!--</td>-->
											<td align="center" style="text-align:center; direction:rtl;"><?= $totalPoints;?></td>
											
<!--                                            <td align="center" style="text-align:center; direction:rtl;">--><?//= $Bonuses;?><!--</td>-->
