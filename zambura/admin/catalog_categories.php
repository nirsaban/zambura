...
//if ($_POST['catindex'] == "0")
//{
//	$sql= "INSERT INTO `deals_categories` (`title`)  VALUES ('".addslashes($_POST['cattitle'])."')";
...
//	if ($_POST['catindex'] !="0")
//	{
//		$updateQuery = "UPDATE `deals_categories`
//		SET
...
<!--									<li style="text-align:right; background-color:#E0E0E0;"><a href="tips_catagory.php" style="text-align:right"><i class="fa fa-fw fa-circle text-red pull-right" style="padding-top:3px;"></i>קטגוריות דילים</a></li>	-->
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font"><strong>ניהול באנרים חדש </strong></h1>
                                                            ...
                                                            <div class="p-15 bg-white" style="min-height: 61px; text-align:center;">
                                                                ...
                                                                <button class="btn btn-sm btn-default pull-right visible-sm visible-xs" data-toggle="collapse" data-target="#mail-nav" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-bars"></i></button>
                                                                <a href="#"  onClick="addCatagory(0,'','הוספת באנר')" data-toggle="modal" data-target="#tipmodal" data-options="splash-2 splash-ef-9" class="btn btn-sm btn-lightred b-0 br-2 text-strong">הוספת באנר</a>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
										...
										<?
											$i = 0;
											$query = "SELECT * FROM `deals_categories`  ORDER BY `title` ASC";
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "tips_catagory.php?del="+index;
				}
			}
