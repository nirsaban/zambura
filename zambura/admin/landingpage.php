...
if ($_GET['del'])
{
	...
	$sql = "DELETE FROM `landing_page` WHERE `id` = '".$_GET['del']."'";
...
$i = 0;
//LIMIT 50
$query = "SELECT * FROM `landing_page`  ORDER BY `id` DESC ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="partnercode.php" class="pull-right" style="width:100%; text-align:right">הרשמות דף נחיתה <span class="pull-left badge bg-lightred"><? print $num_rows;?></span></a></li>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>הרשמות דף נחיתה (<?= $num_rows;?>)</strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">ת.הרשמה</th>
												<th align="right" width="text-align:right; 30%">קוד הזמנה</th>
												<th align="right" width="text-align:right; 30%">גיל</th>								
												<th align="right" width="text-align:right; 30%">מייל</th>			
												<th align="right" width="text-align:right; 30%">נייד</th>
                                        ...
                                        <tr>
											...
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['friend_code']);?></td>

											
											<td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['age']);?></td>
											
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['email']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['mobile'] );?></td>
								            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['fullname']);?></td>
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "landingpage.php?del="+index;
				}
			}
