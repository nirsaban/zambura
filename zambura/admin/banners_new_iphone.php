...
if ($_GET['del'])
{
	...
	$query = "SELECT * FROM `banners_new` WHERE `android_iphone` = '1' ORDER BY `id` DESC";
...
{
    $total = 0;
    $query4 = "SELECT * FROM `banners_new` WHERE `android_iphone` = '1' ";
...
<head>
    ...
    <body id="minovate" class="appWrapper">
                            ...
                            <div class="tile-body">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        ...
                                        <h1 class="custom-font"><strong>ניהול באנרים אייפון </strong></h1>
                                    ...
                                    <div class="p-15 bg-white" style="min-height: 61px; text-align:center;">
                                        ...
                                        <button class="btn btn-sm btn-default pull-right visible-sm visible-xs" data-toggle="collapse" data-target="#mail-nav" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-bars"></i></button>
                                        <a href="add_banner_new.php?android_iphone=1"    class="btn btn-sm btn-lightred b-0 br-2 text-strong">הוספת באנר</a>
                      ...
                      <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading m-0">
                                                    <a href="edit_banner_new.php?id=<? print $row['id'];?>&name=<? print stripslashes($row['title']);?>&android_iphone=1"   class="mr-1"><? print stripslashes($row['title']);?></a>
													<!--
                                                    ...
                                                    <span class="pull-left text-sm text-muted" >
													 ...
													 <div class="hidden-xs" style="margin-top:5px;">
                                                        ...
                                                        <a href="banners_new_gallery.php?id=<? print $row['id'];?>&name=<? print stripslashes($row['title']);?>&android_iphone=1"   ><button  class="btn btn-primary btn-ef btn-ef-7 btn-ef-7b mb-10" style="font-weight:bold; direction:rtl; background-color: #d6d680;">תמונות <?= $num_deals;?> <i class="glyphicon glyphicon-camera" style="padding-top:5px;  "></i></button>	</a>
                                                        <a href="edit_banner_new.php?id=<? print $row['id'];?>&name=<? print stripslashes($row['title']);?>&android_iphone=1"   ><button  class="btn btn-primary btn-ef btn-ef-7 btn-ef-7b mb-10" style="font-weight:bold; direction:rtl; background-color:#666">עריכה<i class="glyphicon glyphicon-edit" style="padding-top:5px;  "></i></button>	</a>
        ...
        <script>
            ...
            {
                window.location = "edit_banner_new.php?id="+id+"&title="+title;
            }
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
                    window.location = "banners_new_iphone.php?del="+index;
				}
			}	
