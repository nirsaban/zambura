...
if ($_POST['updatenew'])
{
    ...
    if ($_POST['catindex'] == "0")
    {
        ...
        $sql= "INSERT INTO `prizes` (`title`,`image`)  VALUES ('".addslashes($_POST['cattitle'])."','".addslashes($newfile)."')";
    ...
    if ($_POST['catindex'] !="0")
    {
        ...
        $query5 = "SELECT * FROM `prizes` WHERE `id` = '".$_POST['catindex']."'";
...
if ($_GET['del'])
{
	$sql = "DELETE FROM `prizes` WHERE `id` = '".$_GET['del']."'";
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font"><strong>פרסים </strong></h1>
                                                            ...
                                                            <div class="p-15 bg-white" style="min-height: 61px; text-align:center;">
                                                                ...
                                                                <button class="btn btn-sm btn-default pull-right visible-sm visible-xs" data-toggle="collapse" data-target="#mail-nav" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-bars"></i></button>
                                                                <a href="#"  onClick="addCatagory(0,'','הוספת פרס')" data-toggle="modal" data-target="#tipmodal" data-options="splash-2 splash-ef-9" class="btn btn-sm btn-lightred b-0 br-2 text-strong">הוספת פרס</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
													...
													<button  onClick="editCatagory('<?= $row['id'];?>','עריכת פרס')" data-toggle="modal" data-target="#tipmodal" data-options="splash-2 splash-ef-9"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-pencil"></i> Add <i class="after fa fa-plus"></i></button>
											</td>

                                            <td align="center" >
                                                <?
                                                if ($row['image']) {
                                                    print '<a href="' . $configUrl . '/uploads/' . stripslashes($row['image']) . '" target="_blank">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <div class="form-group" style="direction:rtl;">
                                        <label for="exampleInputEmail1">כותרת הפרס:</label>
                                        <input type="text" class="form-control" value='' name="cattitle" id="cattitle" placeholder="כותרת הפרס" required>
                                    </div>
...
//				$("#catfloor").val('');
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "game_prizes.php?del="+index;
				}
			}
