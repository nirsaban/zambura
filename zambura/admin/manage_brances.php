...
//$num_rows50 = mysqli_num_rows($result50);
...
if ($_GET['del'])
{
	...
	*/
	...
	$sql = "DELETE FROM `supplier_brances` WHERE `index` = '".$_GET['del']."'";
                    ...
                    <div class="tbox tbox-sm">
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 bg-white" style="min-height: 61px; text-align:center;">
                                ...
                                <a href="new_branch.php?supplier=<?= $_GET['id'];?>"  class="btn btn-sm btn-lightred b-0 br-2 text-strong">הוספת סניף</a>
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font" style="direction:rtl;"><strong>ניהול סניפים - <?= stripslashes($row50['name']);?></strong></h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table hover" id="basic-usage">
                                            ...
                                            <tr>
												...
												<th align="right" width="text-align:right; 30%">כתובת</th>
												<th width="5%">Id</th>
										...
										<?
											$i = 0;
											$query = "SELECT * FROM `supplier_brances`  WHERE `supplier_id` = '".$_GET['id']."' ORDER BY `index` DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
												...
												<button  onClick="editBranch('<?= $row['index'];?>')"  class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-pencil"></i> Add <i class="after fa fa-plus"></i></button>
	...
	?>
        ...
        ================================================ -->
         <script>
			...
			{
				window.location = "edit_branch.php?supplier=<?= $_GET['id'];?>&id="+index;
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "manage_brances.php?id=<?= $_GET['id'];?>&del="+index;
				}
			}
