...
$i = 0;
//LIMIT 50
$query = "SELECT * FROM `users`  WHERE `partnerCode` != '' AND `date` >= '2018-08-01' AND `deleted` = '0' ORDER BY `index` DESC ";
                        ...
                        <div class="tcol w-md bg-tr-white lt b-r">
                            ...
                            <div class="p-15 collapse collapse-xs collapse-sm" id="mail-nav">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-sm" id="mail-folders" >
                                    <li class="active" ><a href="partnercode.php" class="pull-right" style="width:100%; text-align:right">משתמשים <span class="pull-left badge bg-lightred"><? print $num_rows;?></span></a></li>
                                ...
                                <div class="tile-body">
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['wrongAnswers']);?></td>
                                            <td align="center" style="text-align:center; direction:rtl;"><?= stripslashes($row['correctAnswers']);?></td>
                                            -->
        ...
        ================================================ -->
         <script>
			...
			function ConfirmDelete(index)
			{
				...
				if (confirmbox)
				{
					window.location = "partnercode.php?del="+index;
				}
			}
