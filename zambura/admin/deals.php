...
if ($_POST['deal_date'])
{
	//$query1 = "SELECT * FROM `deal_dates`  WHERE `type` = '".$_POST['sugselect']."' AND `deal_id` = '".$_POST['questionid']."' AND `date` = '".$_POST['deal_date']."' ORDER BY `index` DESC";
...
<!--									<li style="text-align:right; background-color:#E0E0E0;"><a href="deals.php" style="text-align:right"><i class="fa fa-fw fa-circle text-red pull-right" style="padding-top:3px;"></i>דילים</a></li>-->
						...
						<div class="col-md-12" style="text-align:right; margin-top:15px; ">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <h1 class="custom-font"><strong>דילים </strong></h1>
	...
	?>
        ...
        ================================================ -->
         <script>
			...
			{
				window.location = "edit_deal.php?id="+index;
