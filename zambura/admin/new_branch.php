...
*/
		...
		$sql= "INSERT INTO `supplier_brances` (`supplier_id`,`address`,`location_lat`,
		`location_lng`,`name`)  VALUES (
		'".addslashes($_GET['supplier'])."',
						...
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>הוספת סניף</strong> </h1>
                                </div>
                                <!-- /tile header -->
