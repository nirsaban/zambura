...
$query = "SELECT * FROM `banners_new` WHERE `id` = '".$_GET['id']."'";
...
if ($_POST['insert'])
{
    ...
    $updateQuery = "UPDATE `banners_new` 
	 SET   
	 `title` ='".addslashes($_POST['banner_title'])."',	 
	 `supplier_name` ='".addslashes($_POST['supplier_name'])."',
	 `code` ='".addslashes($_POST['html_code'])."',
	 `banner_type` ='".addslashes($_POST['banner_type'])."',
	 `internal_ad` ='".addslashes($_POST['internal_ad'])."',
	 `external_url` ='".addslashes($_POST['external_url'])."'
						...
						?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>עריכת באנר</strong> </h1>
                                </div>
                                <!-- /tile header -->
                                    ...
                                    <form name="form2" action="" method="post" role="form" id="form2" enctype="multipart/form-data" data-parsley-validate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="supplier_name"  id="supplier_name" value='<?= stripslashes($row['supplier_name']);?>' class="form-control" tab-index="1"  required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="suppliername">כותרת: </label>
                                                <input type="text" name="banner_title"  id="banner_title" value='<?= stripslashes($row['title']);?>' class="form-control" tab-index="1"  required>
                                            </div>
										...
										<div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="banner_type" class="form-control"  required>
                                                    <option value="0" <?php if ($row['banner_type'] == "0") { print 'selected'; } ;?>>מעברון</option>
                                                    <option value="1" <?php if ($row['banner_type'] == "1") { print 'selected'; } ;?>>קוביה 350X250</option>
                                                    <option value="2" <?php if ($row['banner_type'] == "2") { print 'selected'; } ;?>>באנר 350X50</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="internal_ad" class="form-control"  required>
                                                    <option value="0" <?php if ($row['internal_ad'] == "0") { print 'selected'; } ;?>>פרסומת עצמאית</option>
                                                    <option value="1" <?php if ($row['internal_ad'] == "1") { print 'selected'; } ;?>>פרסומת חיצונית </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="external_url"  id="external_url" value='<?= stripslashes($row['external_url']);?>'  class="form-control" tab-index="1"  >
                                            </div>
                                        </div>
...
<!--                                        </div>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="8" name="html_code"  dir="ltr" placeholder="קוד HTML" ><?= stripslashes($row['code']);?></textarea>
                                        </div>
